...
| autoconfig        | string  | **Optional** | false               | Experimental
| sections          | list    | **Optional** |                     | Entities to show divided by sections, see [sections object](#sections-object) for additional options.
