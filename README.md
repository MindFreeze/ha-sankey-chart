...
| convert_units_to  | string  | **Optional** |                     | If entities are electricity (kWh) or gas (ft³) usage, convert them to carbon (gCO2). For gCO2, all kWh values will be multiplied by the varying grid CO2 intensity, as with the Energy Dashboard.
